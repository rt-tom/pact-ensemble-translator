...
providers:
  local:
    ...
    models:
      ...
      qwen:    {model_key: qwen,   model_path: C:/llama-cpp/models/Qwen3.6-35B-A3B-MTP/Qwen3.6-35B-A3B-UD-Q4_K_XL.gguf, model_name: Qwen3.6-35B-A3B-UD-Q4_K_XL.gguf, server_args: [--spec-type, draft-mtp, -fit, "on", -fitt, "1280", -b, "2048", -ub, "2048", -ctk, q8_0, -ctv, q8_0, -t, "6", -tb, "12", --load-mode, mmap, --reasoning, "on", --reasoning-budget, "8192", --reasoning-budget-enable, -np, "1", -c, "49152", -fa, "on", --jinja, --cache-ram, "0", --ctx-checkpoints, "0"], reasoning_budget: 8192, request: {temperature: 0.0}}
...
Tuned `qwen` (Qwen3.6-35B-A3B) profile: `-ub "2048"`, `-ctv q8_0`, no `--spec-draft-n-max`, no `--device`; `--reasoning-budget-enable` is required and `reasoning_budget` stays `8192`.
