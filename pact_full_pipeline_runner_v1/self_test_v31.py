...
def run(project_root: Path) -> None:
    ...
    assert "[int]$QwenContextSize = 32768" in runner_script
    assert "$reviewerApi['context_size'] = $QwenContextSize" in runner_script
    assert "'-c',[string]$QwenContextSize" in runner_script
