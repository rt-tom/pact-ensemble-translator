...
2026-07-29. Final Qwen global smoke сохраняет один chapter-wide вызов как основной путь, но при доказанном переполнении контекста рекурсивно делит непрерывный PID-диапазон; это сохраняет обязательное полное покрытие и не превращает прочие model/API failures в fail-open.
